...
public class profile_info extends AppCompatActivity implements Dialog_Reset_Password.ExampleDialogListener {
    ...
    public void openDialog() {
        Dialog_Reset_Password exampleDialog = new Dialog_Reset_Password();
